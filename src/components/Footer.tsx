  ...
  return <footer className="bg-[#0a2f23] text-white">
    <div className="section-container !pb-8 !pt-16">
      ...
      <div className="grid gap-12 md:grid-cols-[minmax(0,1.7fr)_repeat(2,minmax(0,0.7fr))]">
        <div>
          <Link href="/" className="inline-flex items-center gap-3" aria-label="Ir al inicio"><Image src="/correntinos-logo.png" alt="" width={56} height={56} className="h-14 w-14 object-contain" /><span className="text-lg leading-tight text-white" style={{ fontFamily: "var(--font-heading)" }}>Fundación Correntinos<span className="mt-1 block font-sans text-[10px] font-bold uppercase tracking-[0.1em] text-white/55">Contra el cambio climático</span></span></Link>

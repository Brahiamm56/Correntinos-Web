...
export const configuracion = pgTable(
  "configuracion",
  {
    ...
    telefono_fundacion: varchar("telefono_fundacion", { length: 40 }),
    whatsapp_contacto: varchar("whatsapp_contacto", { length: 40 }),
    ubicacion_fundacion: varchar("ubicacion_fundacion", { length: 255 }),
    direccion_retiro: varchar("direccion_retiro", { length: 500 }),
    instrucciones_pedido: text("instrucciones_pedido"),
